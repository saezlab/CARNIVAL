...
variables <- writeLPFile_BS(data,pknList,inputs,0.1,alphaWeight=alphaWeight,condition=condition, repIndex=repIndex,betaWeight=betaWeight,scores=scores,mipGAP=mipGAP,poolrelGAP=poolrelGAP,limitPop=limitPop,poolCap=poolCap,poolIntensity=poolIntensity,timelimit=timelimit,nodeWeights=nodeWeights,measurementsWeights=measurementsWeights)
