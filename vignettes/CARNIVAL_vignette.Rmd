...
# CARNIVAL package's driver script
...
# !!! IMPORTANT !!! #
# Please set the path for executable cplex file
...
# setwd(paste0(current_dir,"/results"))
...
paste0(dir_name,"/results_cplex_",condition,"_",repIndex,".txt"),
