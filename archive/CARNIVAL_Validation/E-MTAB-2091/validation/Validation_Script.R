...
pdf("Hamming_Distance_generic.pdf")
# pdf("Hamming_Distance_omnipath.pdf")
plot(1:length(MeasuredPP),DiffMat[1,],type = 'p',col='red',cex=DiffMat[3,]/10,
     ...
     main = "Average Hamming distance - Generic network",axes = F)
     # main = "Average Hamming distance - Omnipath network",axes = F)
...
write.table(x = ValResMat,file = paste0("Summary_Validation_Results_generic.tsv"),quote = F,sep = "\t",col.names = T,row.names = T)
write.table(x = ValResMatSign,file = paste0("Summary_Validation_Sign_Results_generic.tsv"),quote = F,sep = "\t",col.names = T,row.names = T)
write.table(x = ValResMatSignCutOff,file = paste0("Summary_Validation_SignCutOff_Results_generic.tsv"),quote = F,sep = "\t",col.names = T,row.names = T)
write.table(x = DiffMat,file = paste0("Summary_Validation_HammingDistance_generic.tsv"),quote = F,sep = "\t",col.names = T,row.names = T)

# write.table(x = ValResMat,file = paste0("Summary_Validation_Results_omnipath.tsv"),quote = F,sep = "\t",col.names = T,row.names = T)
# write.table(x = ValResMatSign,file = paste0("Summary_Validation_Sign_Results_omnipath.tsv"),quote = F,sep = "\t",col.names = T,row.names = T)
# write.table(x = ValResMatSignCutOff,file = paste0("Summary_Validation_SignCutOff_Results_omnipath.tsv"),quote = F,sep = "\t",col.names = T,row.names = T)
# write.table(x = DiffMat,file = paste0("Summary_Validation_HammingDistance_omnipath.tsv"),quote = F,sep = "\t",col.names = T,row.names = T)
